...
### 1. Console 1 — CVar flags + transient persistence semantics
- **Status:** Review
- **Completed:** false
- **Priority:** High
...
### 2. Console 2 — AnyTextCodec (Any <-> string parse/format)
- **Status:** Review
- **Completed:** false
- **Priority:** High
...
### 3. Console 3 — SFUNCTION method-reflection codegen + MethodInfo attributes
- **Status:** Review
- **Completed:** false
- **Priority:** High
...
### 4. Console 4 — ConsoleCommand registry + SP_CONSOLE_COMMAND macro
- **Status:** Review
- **Completed:** false
- **Priority:** High
...
### 5. Console 5 — AutoCVar + deferred registration (SP_CVAR)
- **Status:** Review
- **Completed:** false
- **Priority:** High
...
### 7. Console 7 — Console output sink (spdlog -> ring buffer), un-stub Log
- **Status:** Review
- **Completed:** false
- **Priority:** Medium
...
### 8. Console 8 — ConsolePanel widget (output view, input, history, autocomplete)
- **Status:** Review
- **Completed:** false
- **Priority:** High
...
### 9. Console 9 — Integration: lifecycle, toggle key, both layers, CMake, cheat gate
- **Status:** Review
- **Completed:** false
- **Priority:** High
...
### 10. Console 10 — End-to-end verification + docs
- **Status:** Review
- **Completed:** false
- **Priority:** Medium
...
### 11. Deferred — future console work (not scheduled)
- **Status:** Deferred
- **Completed:** false
- **Priority:** Low
